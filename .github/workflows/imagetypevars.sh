...
#
RUNNER_INSTALL_PACKAGES="git autoconf autotools-dev gcc g++ make gdb dh-make fakeroot dpkg-dev devscripts libtool pkg-config procps libyaml-dev chmpx-dev gnutls-dev"
...
if [ -z "${CI_DOCKER_IMAGE_OSTYPE}" ]; then
	...
	PKG_INSTALL_BASE="k2htpdtor bind-tools"
	PKG_INSTALL_DEV="chmpx-dev k2htpdtor bind-tools"
	...
	PKG_INSTALL_CURL="curl"
	PKG_INSTALL_BASE="k2htpdtor dnsutils"
	PKG_INSTALL_DEV="chmpx-dev k2htpdtor dnsutils"
